...
autocmd filetype html inoremap html; <!DOCTYPE html><Return><html><Return><head><Return><title></title><Return><link><Return></head><Return><body><Return></body><Return></html><Esc>/<title><Return>6la
